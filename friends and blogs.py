...
def answer_two():
    ...
    return sorted(centrality.keys(), key=lambda x:centrality[x],reverse=True)[0]# Your Answer Here
...
def answer_six():
    ...
    return sorted(ranks.keys(), key=lambda x: ranks[x], reverse=True)[0:5]# Your Answer Here
...
def answer_eight():
    ...
    return sorted(hub_scores.keys(), key=lambda x: hub_scores[x], reverse=True)[0:5]# Your Answer Here
...
def answer_nine():
    ...
    return sorted(auth_scores.keys(), key=lambda x: auth_scores[x], reverse=True)[0:5]# Your Answer Here
